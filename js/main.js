...
/* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/dynamic-adapt */ "./src/js/components/dynamic-adapt.js");
/* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_get_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/get-header */ "./src/js/components/get-header.js");
...
/* harmony import */ var _components_leaders_cards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/leaders-cards */ "./src/js/components/leaders-cards.js");
/* harmony import */ var _components_leaders_cards__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_leaders_cards__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/pipe */ "./src/js/components/pipe.js");
/* harmony import */ var _components_pipe__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_pipe__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _components_count__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/count */ "./src/js/components/count.js");
/* harmony import */ var _components_count__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_components_count__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var _components_observer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/observer */ "./src/js/components/observer.js");
/* harmony import */ var _components_observer__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_components_observer__WEBPACK_IMPORTED_MODULE_13__);
...
if (workSection) {
  ...
  const countValueFourth = +document.querySelector("[data-count-fourth]").dataset.countFourth;
  const objs = [{
    countItem: document.querySelector(".count-num--one span"),
    countValue: countValueOne,
    arrCount: ["0000", "00" + 42, "0" + 123, "0" + 234, "0" + 258, "0" + 389, "0" + 476, "0" + 789, "0" + 978, 1098, 1123, 1200, countValueOne]
  }, {
    countItem: document.querySelector(".count-num--second span"),
    countValue: countValueSecond,
    arrCount: ["000", "0" + 30, "0" + 48, 100, 132, 179, 197, 200, 222, 236, 240, countValueSecond]
  }, {
  ...
  function printNumbers() {
    ...
    setTimeout(function run() {
      if (i < objs[0].arrCount.length || i < objs[1].arrCount.length || i < objs[2].arrCount.length || i < objs[3].arrCount.length) {
        go(i);
        i++;
        setTimeout(run, 50);
      }
...
/***/ "./src/js/components/get-header.js":
/*!*****************************************!*\
  !*** ./src/js/components/get-header.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/leaders-cards.js":
/*!********************************************!*\
  !*** ./src/js/components/leaders-cards.js ***!
  \********************************************/
/***/ (() => {
...
function swiperCardLeaders() {
  if (window.innerWidth <= 600) {
    if (!initLeaders) {
      initLeaders = true;
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
      let swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".leaders-swiper", {
        slidesPerView: 1,
        spaceBetween: 10,
        speed: 1000,
        loop: true,
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".about-company__swiper", {
  slidesPerView: 1,
  spaceBetween: 10,
  speed: 1000,
  loop: true,
...
function swiperCardGrid() {
  if (window.innerWidth <= 600) {
    if (!initGrid) {
      initGrid = true;
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
      let swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".about-grid__images", {
        slidesPerView: 1,
        spaceBetween: 20,
        speed: 1000,
        loop: true,
...
function swiperCardHistory() {
  if (window.innerWidth <= 600) {
    if (!initHistory) {
      initHistory = true;
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
      let swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".about-history__items", {
        slidesPerView: 1,
        spaceBetween: 20,
        speed: 1000,
        loop: true,
...
function swiperCardSingle() {
  if (window.innerWidth <= 600) {
    if (!initSingle) {
      initSingle = true;
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard]);
      let swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".single-swiper", {
        slidesPerView: 1,
        spaceBetween: 20,
        speed: 1000,
        loop: true,
...
(function () {
  const parentBurger = document.querySelector(".menu-burger");
  ...
  parentBurger?.addEventListener("click", e => {
    ...
    burger?.parentElement.classList.toggle("menu-burger--active");
